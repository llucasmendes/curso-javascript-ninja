...
var operation = {
	...
	*/
	function isOperatorValid(operador){
		var operadores = ['+', '-', '*', '/','%'];
		return operadores.includes(operador) ? true : false;
	}
	...
	*/
	...
	operationSignal = '*';
	var plus = calculator(operationSignal);
	if(plus){
		number1 = 10;
		number2 = 12;
		console.log(showOperationMessage(operationSignal, number1, number2), plus(number1, number2));
  } else {
		console.log(showErrorMessage(operationSignal));
	}
	operationSignal = '/';
